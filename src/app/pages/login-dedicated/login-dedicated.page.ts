...
@Component({
  selector: "app-login-dedicated",
  templateUrl: "./login-dedicated.page.html",
  styleUrls: ["./login-dedicated.page.scss"]
})
export class LoginDedicatedPage implements OnInit {
  loading = false;
  showPass = false;
